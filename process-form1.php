...
if(!empty($name)&&!empty($phone)&&!empty($email)&&!empty($message)){  
               $query = "INSERT INTO counselling(serial,name,phone,email,message,roll,year,branch,nature,urgency) 
				VALUES('','$name','$phone','$email','$message','$roll','$year','$branch','$nature','$urgency')";
...
if (!empty($fields))
{
    ...
    if (empty($error_list))
    {
        ...
        if (mail($email_address, $subject, $content, "From: " . $fields['email'] . "\r\nReply-To: " . $fields['email'] . "\r\nReturn-Path: " . $fields['email'] . "\r\n"))
        {
            ...
            echo "<br/><p class='success'>Thank you <strong>" . $fields['name'] . "</strong>, your message has been submitted. Further details will be provided as soon as your session 
		with the faculty is finalized. This may take at most 7 days.</p>";
